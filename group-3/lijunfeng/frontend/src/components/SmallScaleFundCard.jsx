        ...
        return (
          <button
            ...
            className="
              ...
              text-left focus:outline-none focus:ring-2 focus:ring-purple-400
            "
          >
            {/* 基金名称 */}
...
export default SmallScaleFundCard;
